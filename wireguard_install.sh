#!/bin/bash
#
# This is my copy of the script found below. I have modified it, slightly but all credit goes to the original author. 
#
...
if [ ! -f "$WG_CONFIG" ]; then
    ...
    PRIVATE_SUBNET=${PRIVATE_SUBNET:-"10.99.0.0/24"}
